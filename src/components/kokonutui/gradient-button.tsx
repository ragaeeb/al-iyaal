...
interface GradientColors {
    ...
    light: { border: string; base: string; overlay: string; accent: string; text: string; glow: string; hover: string };
}
...
export default function GradientButton({
    ...
    return (
        <Button
            variant="ghost"
            className={cn('group relative h-12 overflow-hidden rounded-lg px-4 transition-all duration-500', className)}
            {...props}
        >
            <div
                className={cn(
            ...
            >
                <div className={cn('absolute inset-0 rounded-lg opacity-90', 'bg-white/80', 'dark:bg-[#0C1F21]')} />
            </div>

            <div className={cn('absolute inset-[2px] rounded-lg opacity-95', 'bg-white/80', 'dark:bg-[#0C1F21]')} />
